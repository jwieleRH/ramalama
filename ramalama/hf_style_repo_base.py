...
class HFStyleRepository(ABC):
    ...
    def get_file_list(self, cached_files: list[str]) -> list[SnapshotFile]:
        ...
        # Other files
        # TODO: Set should_verify_checksum to True either by calculating a content hash or
        # relaxing the length requrement for non lfs files which have a shorter oid.
